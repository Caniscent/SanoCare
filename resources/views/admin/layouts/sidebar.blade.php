      ...
      <ul class="space-y-2">
        <li>
            <x-nav-link :href="route('admin.index')" :active="request()->routeIs('admin.index')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-6 h-6 mr-3"  viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        <li>
            <details>
                <summary class="flex items-center px-4 py-2 rounded cursor-pointer hover:bg-blue-600">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"  class="w-6 h-6 mr-3" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <ul class="pl-6 mt-2 space-y-1">
                    <li>
                        <a href="{{route('admin.profile.index')}}" class="flex items-center px-4 py-2 rounded hover:bg-blue-700 ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-6 h-6 mr-3" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button class="flex items-center w-full px-4 py-2 rounded hover:bg-blue-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-6 h-6 mr-3" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
