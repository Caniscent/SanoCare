    ...
    <table class="table-auto w-full border-collapse border border-gray-200 text-sm sm:text-base">
        <thead>
            <tr class="bg-gray-200">
                ...
                <x-table.th class="hidden sm:table-cell">Tanggal Dipublish</x-table.th>
                <x-table.th class="hidden sm:table-cell">Tanggal Dibuat</x-table.th>
        ...
        <x-table.tbody>
            ...
            <x-table.tr>
                ...
                <x-table.td class="hidden sm:table-cell">{{ $data->created_at->format('d M Y') }}</x-table.td>
