...
class CleanFoodRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'food_group_id.required' => 'Kelompok makanan wajib dipilih.',
            'food_group_id.exists' => 'Kelompok makanan yang dipilih tidak valid.',
            'food_type_id.required' => 'Jenis makanan wajib dipilih.',
            'food_type_id.exists' => 'Jenis makanan yang dipilih tidak valid.',
